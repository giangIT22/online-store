@extends('layouts.admin', ['titlePage' => 'Chỉnh sửa bài viết'])
@section('content')
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{ route('blog.update', ['blog_id' => $blog->id]) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="content" class="form-control" cols="30" rows="4">{{$blog->content}}</textarea>
                                                        @error('description')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div id="preview_img">
                                                    <img width="150px" id="showImage" src="{{$blog->post_image}}" alt=""
