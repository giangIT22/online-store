      ...
      <div class='row'>
        ...
        <div class='col-md-9'> 
          ...
          <div id="category" class="category-carousel hidden-xs">
            <div class="item">
              <div class="image"> <img src="{{ $slider->slider_image }}" alt="" class="img-responsive"> </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col col-sm-6 col-md-4 text-right">
                <div class="pagination-container">
                  <ul class="list-inline list-unstyled">
                    <li class="prev"><a href="?page={{$currentPage ==1 ? $currentPage : $currentPage -1}} "><i class="fa fa-angle-left"></i></a></li>
                      @for ($i = 1; $i <= $lastPage; $i++)
                        <li class="{{ $i == $currentPage ? 'active' : ''}}"><a href="?page={{ $i }}">{{ $i }}</a></li>
                      @endfor
                    <li class="next"><a href="?page={{$currentPage + 1}} "><i class="fa fa-angle-right"></i></a></li>
                  </ul>
                </div>
              </div>
              <!-- /.col --> 
                              ...
                              <div class="product-price"> 
                                @if ($product->sale_price)
                                	<span class="price"> {{ number_format($product->sale_price)}} đ</span>
									                <span class="price-before-discount">{{ number_format($product->product_price) }} đ</span>
                                @else
